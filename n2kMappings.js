...
exports.mappings = {
  ...
  '130820': [{
    source: 'Name',
    node: 'entertainment.fusion1.name',
    ...
    source: 'Album',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.albumName'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Track Album'  && n2k.fields.Album != 0 && currentFusionSource != null }
  }, {
    source: 'Track',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.name'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Track Title'  && n2k.fields.Track != 0  && currentFusionSource != null  }	
  }, {
    source: 'Progress',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.elapsedTime'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Track Progress' && currentFusionSource != null }
  }, {
    source: 'Track Length',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.length'} ,
    ...
    source: 'Channel',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.tuner.stationName'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'SiriusXM Channel' && currentFusionSource != null  }
  }, {
    source: 'Genre',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.genre'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'SiriusXM Genre' && currentFusionSource != null }
  }, {
    source: 'Track #',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.number'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Track Info' && currentFusionSource != null }
  }, {
    source: 'Track Count',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.track.totalTracks'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Track Info' && currentFusionSource != null }
  }, {
    node: 'entertainment.fusion1.output.zone1.volume',
    source: 'Zone 1',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.fusion1.output.zone2.volume',
    source: 'Zone 2',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.fusion1.output.zone3.volume',
    source: 'Zone 3',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.fusion1.output.zone4.volume',
    source: 'Zone 4',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: function (n2k) { return 'entertainment.fusion1.output.zone' + (Number(n2k.fields.Number)+1) + '.name' },
    ...
    node: 'entertainment.fusion1.output.zone1.source',
     value: function(n2k) {
       currentFusionSource = n2k.fields['Current Source ID']
       return 'entertainment.fusion1.avsource.source' + n2k.fields['Current Source ID']
     },
     filter: function(n2k) { return n2k.fields['Message ID'] == 'Source' }
   }, {
    node: 'entertainment.fusion1.output.zone2.source',
     value: function(n2k) {
       return 'entertainment.fusion1.avsource.source' + n2k.fields['Current Source ID']
     },
     filter: function(n2k) { return n2k.fields['Message ID'] == 'Source' }
   }, {
     node: 'entertainment.fusion1.output.zone3.source',
     value: function(n2k) {
       return 'entertainment.fusion1.avsource.source' + n2k.fields['Current Source ID']
     },
     filter: function(n2k) { return n2k.fields['Message ID'] == 'Source' }
   }, {
     node: 'entertainment.fusion1.output.zone4.source',
     value: function(n2k) {
       return 'entertainment.fusion1.avsource.source' + n2k.fields['Current Source ID']
     },
     filter: function(n2k) { return n2k.fields['Message ID'] == 'Source' }
    ...
    node: 'entertainment.fusion1.output',
    value: function(n2k) {
      var id = n2k.fields['Current Source ID']
      var sourceName = fusionSources[id]
      return {
        "zone1": { "source": sourceName },
        "zone2": { "source": sourceName },
        "zone3": { "source": sourceName },
        "zone4": { "source": sourceName }
      }
    },
    filter: function(n2k) {
      if ( n2k.fields['Message ID'] == 'Source' )
      {
        var id = n2k.fields['Current Source ID']
        return typeof fusionSources[id] != 'undefined'
      }
      return false
    }
*/
  }, {
    node: function (n2k) { return 'entertainment.fusion1.avsource.source' + n2k.fields['Source ID'] + '.name' },
    value: function(n2k) {
    ...
    source: 'AM/FM',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.tuner.mode'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'AM/FM Station' && currentFusionSource != null}
  }, {
    source: 'Frequency',
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.tuner.frequency'} ,
    filter: function(n2k) { return n2k.fields['Message ID'] == 'AM/FM Station' && currentFusionSource != null }
  }, {
    node: function(n2k) { return 'entertainment.fusion1.avsource.source' + currentFusionSource + '.playbackState'} ,
    value: function(n2k) {
    ...
    node: 'entertainment.fusion1.output.zone1.isMuted',
    value: function(n2k) {
    ...
    node: 'entertainment.fusion1.output.zone2.isMuted',
    value: function(n2k) {
      var val = n2k.fields['Mute']
      return val == 'Muted' ? true : false
    },
    ...
    node: 'entertainment.fusion1.output.zone3.isMuted',
    value: function(n2k) {
      var val = n2k.fields['Mute']
      return val == 'Muted' ? true : false
    },
    ...
    node: 'entertainment.fusion1.output.zone4.isMuted',
    value: function(n2k) {
      var val = n2k.fields['Mute']
      return val == 'Muted' ? true : false
    },
    ...
    node: 'entertainment.fusion1.output.zone1.equalizer',
    value: function(n2k) {
      return {
    ...
    node: 'entertainment.fusion1.output.zone2.equalizer',
    value: function(n2k) {
      return {
	bass: Number(n2k.fields.Bass),
	mid: Number(n2k.fields.Mid),
    ...
    node: 'entertainment.fusion1.output.zone3.equalizer',
    value: function(n2k) {
      return {
	bass: Number(n2k.fields.Bass),
	mid: Number(n2k.fields.Mid),
    ...
    node: 'entertainment.fusion1.output.zone4.equalizer',
    value: function(n2k) {
      return {
	bass: Number(n2k.fields.Bass),
	mid: Number(n2k.fields.Mid),
