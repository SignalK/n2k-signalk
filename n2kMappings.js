...
exports.mappings = {
  ...
  '130820': [{
    ...
    node: 'entertainment.device.fusion1.output.zone1.volume',
    source: 'Zone 1',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.device.fusion1.output.zone2.volume',
    source: 'Zone 2',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.device.fusion1.output.zone3.volume',
    source: 'Zone 3',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
    node: 'entertainment.device.fusion1.output.zone4.volume',
    source: 'Zone 4',
    filter: function(n2k) { return n2k.fields['Message ID'] == 'Volume' }
  }, {
