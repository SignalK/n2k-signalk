...
describe('127489 engine parameters Port', function () {
  it('complete engine params sentence converts', function () {
    ...
    tree.should.have.nested.property('propulsion.port.alternatorVoltage.value', 12.60);
    tree.should.have.nested.property('propulsion.port.fuel.rate');
    tree.should.have.nested.property('propulsion.port.fuel.rate.value', 1.1111111111111112e-7);
...
describe('127489 engine parameters Starboard', function () {
  it('complete engine params sentence converts', function () {
    ...
    tree.should.have.nested.property('propulsion.starboard.alternatorVoltage.value', 12.60);
    tree.should.have.nested.property('propulsion.starboard.fuel.rate');
    tree.should.have.nested.property('propulsion.starboard.fuel.rate.value', 2.777777777777778e-8);
