...
describe('127489 engine parameters Port', function () {
  it('complete engine params sentence converts', function () {
    ...
    tree.should.have.deep.property('propulsion.port.alternatorPotential');
    tree.should.have.deep.property('propulsion.port.alternatorPotential.value', 12.60);
...
describe('127489 engine parameters Starboard', function () {
  it('complete engine params sentence converts', function () {
    ...
    tree.should.have.deep.property('propulsion.starboard.alternatorPotential');
    tree.should.have.deep.property('propulsion.starboard.alternatorPotential.value', 12.60);
