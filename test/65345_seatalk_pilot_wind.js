...
describe('65345 Seatalk Wind Datum', function () {
  it('complet wind datum sentence converts positive', function () {
    ...
    tree.should.have.nested.property('steering.autopilot.target.windAngleApparent.value', 1.0265);
  ...
  it('complet wind datum sentence converts negative', function () {
    ...
    tree.should.have.nested.property('steering.autopilot.target.windAngleApparent.value', -1.1377853071795858);
    tree.should.be.validSignalKVesselIgnoringIdentity;
  });  
});
