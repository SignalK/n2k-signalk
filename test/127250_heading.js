...
describe('127250 Heading', function () {
  it('Magnetic sentence converts', function () {
    ...
    msgs.should.contain.an.item.with.deep.property('navigation.headingMagnetic.value', 129.7);
  });
  ...
  it('Variation sentence converts', function () {
    ...
    msgs.length.should.equal(1);
    msgs.should.contain.an.item.with.deep.property('navigation.magneticVariation.value', 8);
  });
});
