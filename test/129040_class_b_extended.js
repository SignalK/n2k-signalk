...
describe('129040 AIS Class B Extended Position Repeat', function () {
  it('complete sentence converts', function () {
    ...
    tree.should.have.nested.property('design.aisShipType.value', 51);
    tree.should.have.nested.property('design.beam.value', 4.0);
    tree.should.have.nested.property('navigation.destination.commonName.value', "HELSINKI LIFEBOAT");
