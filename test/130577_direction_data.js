...
describe('130577 direction_data sentence without drift', function() {
  ...
  it('has correct values', function() {
    ...
    tree.should.have.nested.property('navigation.courseOverGroundTrue.value', 70.1);
    tree.should.have.nested.property('navigation.courseOverGroundTrue.value', 70.1);
  });
...
describe('130577 direction_data sentence with drift', function() {
  ...
  it('has correct values', function() {
    ...
    tree.should.have.nested.property('navigation.courseOverGroundTrue.value', 206.9);
