...
describe('130306 Wind Data', function () {
  it('Apparent sentence converts', function () {
    ...
    msgs.should.contain.an.item.with.deep.property('environmental.windSpeedApparent.value', 6.22);
    msgs.should.contain.an.item.with.deep.property('environmental.windAngleApparent.value', 50.0);
  });
  ...
  it('True Boat sentence converts', function () {
    ...
    msgs.length.should.equal(2);
    msgs.should.contain.an.item.with.deep.property('environmental.windSpeedTrueBoat.value', 4.89);
    msgs.should.contain.an.item.with.deep.property('environmental.windAngleTrueBoat.value', 86);
  });
  ...
  it('True Ground sentence converts', function () {
    ...
    msgs.length.should.equal(2);
    msgs.should.contain.an.item.with.deep.property('environmental.windSpeedTrueGround.value', 4.82);
    msgs.should.contain.an.item.with.deep.property('environmental.windAngleTrueGround.value', 218.6);
  });
