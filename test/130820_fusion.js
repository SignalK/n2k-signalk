...
describe('130820 Fusion Stereo', function () {
  it('complet device name sentence converts', function () {
    var tree = require("../n2kMapper.js").toNested(
      JSON.parse('{"timestamp":"2016-11-26T20:40:00.895Z","prio":7,"src":10,"dst":255,"pgn":130820,"description":"Fusion: Unit Name","fields":{"Manufacturer Code":"Fusion","Industry Code":"Marine Industry","Message ID":"Unit Name","A":128,"Name":"Fusion"}}'));
    tree.should.have.deep.property('entertainment.device.fusion1.name.value', 'Fusion');
  });
  ...
  it('complet volume sentence converts', function () {
    ...
    tree.should.have.deep.property('entertainment.device.fusion1.output.zone1.volume.value', 10);
    tree.should.have.deep.property('entertainment.device.fusion1.output.zone2.volume.value', 11);
    tree.should.have.deep.property('entertainment.device.fusion1.output.zone3.volume.value', 12);
    tree.should.have.deep.property('entertainment.device.fusion1.output.zone4.volume.value', 13);
  });
