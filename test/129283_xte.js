...
describe('129283 cross track error', function () {
  it('complete cross track error converts', function () {
    ...
    var tree = mapper.toNested(
      JSON.parse('{"timestamp":"2016-08-11T07:58:36.263Z","prio":3,"src":3,"dst":255,"pgn":129283,"description":"Cross Track Error","fields":{"XTE mode":"Autonomous","Navigation Terminated":"No","XTE":-5.63}}'), state);
