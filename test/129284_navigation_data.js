...
describe('129284 Navigation Data', function () {
  it('complete sentence converts', function () {
    ...
    tree.should.have.deep.property('navigation.courseGreatCircle.nextPoint.velocityMadeGood.value', 0.06);
    tree.should.have.deep.property('navigation.courseGreatCircle.nextPoint.distance.value', 1910.38);
    ...
    tree.should.have.deep.property('navigation.courseGreatCircle.activeRoute.estimatedTimeOfArrival.value', '2016-05-04T03:01:46Z');
