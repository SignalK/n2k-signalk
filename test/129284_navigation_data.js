...
describe('129284 Navigation Data', function () {
  it('complete sentence converts', function () {
    var msg = JSON.parse('{"timestamp":"2016-05-03T18:19:05.588Z","prio":3,"src":4,"dst":255,"pgn":129284,"description":"Navigation Data","fields":{"SID":231,"Distance to Waypoint":1910.38,"Course/Bearing reference":"True","Perpendicular Crossed":"No","Arrival Circle Entered":"Yes","Calculation Type":"Great Circle", "ETA Time": "03:01:46","ETA Date":"2016.05.04","Bearing, Origin to Destination Waypoint":2.6435,"Bearing, Position to Destination Waypoint":2.7651,"Origin Waypoint Number":0,"Destination Waypoint Number":1,"Destination Latitude":60.1366607,"Destination Longitude":24.9068518,"Waypoint Closing Velocity":0.06}}');
    ...
    tree.should.have.deep.property('notifications.waypointArrival.message', 'Waypoint Arrival');
    tree.should.have.deep.property('notifications.waypointArrival.method', 'visual');
    tree.should.have.deep.property('notifications.waypointArrival.state', 'alert');
