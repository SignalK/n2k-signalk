...
describe('129026 COG & SOG, Rapid Update', function () {
  ...
  it('just COG converts', function () {
    var tree = require("../n2kMapper.js").toNested(
      JSON.parse('{"timestamp":"2015-01-15-16:25:12.021","prio":2,"src":245,"dst":255,"pgn":129026,"description":"COG & SOG, Rapid Update","fields":{"SID":138,"COG Reference":"True","SOG":0.00}}'));
