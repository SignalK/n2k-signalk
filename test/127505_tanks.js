...
describe('127505 tanks', function () {
  it('complete sentence converts', function () {
    ...
    tree.should.have.deep.property('tanks.Fuel_0.currentLevel', 30.280);
    tree.should.have.deep.property('tanks.Fuel_0.capacity', 49.0);
    tree.should.have.deep.property('tanks.Fuel_0.name', 'Fuel 0');
