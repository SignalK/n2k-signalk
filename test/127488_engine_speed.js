...
describe('127488 engine speed Port', function () {
  it('complete engine speed sentence converts', function () {
    ...
    tree.should.have.nested.property('propulsion.port.revolutions.value', 53.166666666666664);
...
describe('127488 engine speed Starboard', function () {
  it('complete engine speed sentence converts', function () {
    ...
    tree.should.have.nested.property('propulsion.starboard.revolutions.value', 53.166666666666664);
    tree.should.be.validSignalKVesselIgnoringIdentity;
  });
});
